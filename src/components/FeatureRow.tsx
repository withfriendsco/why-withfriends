...
const FeatureRow = ({ imageFirst, featureRow }: FeatureRowData) => {
	return (
		<div className="w-full flex justify-center my-8">
			<div className="max-w-screen-xl w-full flex flex-wrap sm:flex-nowrap justify-center text-center sm:text-left">
				...
				<div className="flex-1 order-1 -mx-4 sm:-mx-8 px-8 sm:mx-0 sm:px-0">
